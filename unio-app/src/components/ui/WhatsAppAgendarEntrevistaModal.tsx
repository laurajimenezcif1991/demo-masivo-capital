...
const AM_SLOTS = [
  'Sáb 21 Jun · 8:00 AM — Patio de Operaciones Masivo Capital, Suba',
  'Sáb 21 Jun · 9:30 AM — Patio de Operaciones Masivo Capital, Suba',
  'Dom 22 Jun · 8:00 AM — Patio de Operaciones Masivo Capital, Suba',
  'Sáb 28 Jun · 8:00 AM — Patio de Operaciones Masivo Capital, Suba',
];
const PM_SLOTS = [
  'Sáb 21 Jun · 2:00 PM — Sede Operativa Masivo Capital, Engativá',
  'Dom 22 Jun · 2:00 PM — Sede Operativa Masivo Capital, Engativá',
  'Sáb 28 Jun · 2:30 PM — Sede Operativa Masivo Capital, Engativá',
  'Dom 29 Jun · 2:00 PM — Sede Operativa Masivo Capital, Engativá',
];
...
function buildOpening(firstName: string, jobTitle: string): WaMsg[] {
  ...
  return [
    { from: 'alex', time: fmt(0), text: `¡Hola ${firstName}! 👋 Soy *Alex*, asistente de selección de *Masivo Capital*.` },
