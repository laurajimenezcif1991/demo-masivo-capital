...
function buildOpening(firstName: string, jobTitle: string): WaMsg[] {
  const base = new Date();
  return [
    { from: 'alex', time: fmt(base, 0), text: `¡Hola ${firstName}! 👋 Soy *Alex*, asistente de selección de *Masivo Capital*.` },
    ...
    { from: 'alex', time: fmt(base, 2), text: `Para iniciar tu proceso de *vinculación* con Masivo Capital, necesitamos reunir algunos documentos. Te los comparto a continuación 📋` },  ];
}
...
function buildConfirmation(firstName: string): WaMsg[] {
  ...
  return [
    ...
    { from: 'alex', time: fmt(base, 9), text: `¡Bienvenido/a al equipo de Masivo Capital! 🚌 ¡Mucho éxito en este nuevo camino en la movilidad de Bogotá! 😊` },
  ];
}
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '20px 24px 18px', borderBottom: '1px solid #F0F0F0' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '13px', color: '#666', marginTop: '1px' }}>Alex IA · Masivo Capital Talent</div>
                </div>
              ...
              <div style={{ padding: '24px', overflowY: 'auto' }}>
                <div style={{
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: '14px', color: '#15803D' }}>Masivo Capital Talent</div>
                    <p style={{ fontSize: '13px', color: '#166534', margin: '4px 0 0', lineHeight: 1.55 }}>
                      Alex felicita al conductor y le solicita automáticamente por WhatsApp los documentos obligatorios para el proceso de contratación: examen médico, documentos de identidad, licencia, cuenta bancaria y RUT.
                    </p>
                  </div>
                </div>
            ...
            <div style={{ display: 'flex', flex: 1, overflow: 'hidden', maxHeight: '90vh' }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                ...
                <div style={{ background: '#128C7E', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ fontWeight: 700, fontSize: '14px', color: '#fff' }}>Masivo Capital Talent</div>
