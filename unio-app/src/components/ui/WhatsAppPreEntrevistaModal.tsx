...
function buildConversation(firstName: string, jobTitle: string, aspiration: string): WaMsg[] {
  ...
  return [
    // 0-2 Apertura
    { from: 'alex',      time: fmt(0),  text: `Hola ${firstName}! 👋 Soy *Alex*, asistente de selección de *Masivo Capital*. Tu perfil quedó bien ranqueado para *${jobTitle}*. ¿Tienes unos 10 minutos para una verificación rápida?` },
    ...
    { from: 'alex',      time: fmt(15), text: `¡Perfecto, ${firstName}! 🙌 Sus datos están bien. El equipo de selección de Masivo Capital revisará su información en RUNT y le contactará para los próximos pasos. ¿Tiene alguna duda?` },
    { from: 'candidate', time: fmt(16), text: 'No, todo claro. ¡Muchas gracias! 😊' },
    { from: 'alex',      time: fmt(17), text: `¡Fue un gusto, ${firstName}! Masivo Capital le estará escribiendo pronto. ¡Mucho éxito! ✅` },
  ];
}
