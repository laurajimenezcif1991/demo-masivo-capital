  ...
  return {
    ...
    qm_fail: {
      botMessages: [
        ...
        'Te invitamos a estar atento/a a futuras oportunidades con *Masivo Capital*. ¡Mucho éxito! 💪',
      ],
      next: () => 'qm_fail',
    },
    ...
    ps_empresa: {
      botMessages: [
        '¡Genial! Déjame contarte un poco sobre *Masivo Capital* 🏢',
      ],
      card: {
    ...
    ps_complete: {
      botMessages: [
        ...
        'Gracias por tu tiempo y tu interés en *Masivo Capital*. ¡Mucho éxito! 💪',
      ],
      next: () => 'ps_complete',
    },
  };
...
function WaHeader() {
  return (
    <div style={{
      ...
      <div style={{ flex: 1 }}>
        <div style={{ color: '#fff', fontWeight: 700, fontSize: '15px', lineHeight: 1.2 }}>Masivo Capital Talent</div>
